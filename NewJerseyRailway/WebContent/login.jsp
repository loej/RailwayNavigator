...
<div class="bar"> 
	<nav class="navbar navbar-expand-sm bg-blue navbar-dark" style="background-color: #698474;">
  	...
  	<ul class="navbar-nav">
    	...
    	<li class="nav-item">
      		<a class="nav-link" href="Customer%20Rep/Customer_login.jsp">Log in as a Customer Rep</a>
		</li>    	
    <!-- Dropdown 
...
<div class="card" style="width: 18rem;" >
  <div class="card-body">
    ...
    <a href="Customer%20Rep/Customer_login.jsp" class="card-link">Customer Rep. Link!</a>
  </div>
</div>
</th>
</tr>
